<div class="max-w-3xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-semibold text-ink">Edit Lesson</h1>
        </div>
    ...
    <form wire:submit="save" class="bg-white rounded border border-gray-200 p-6 space-y-5">
        ...
        <div class="border-t border-gray-100 pt-5 flex gap-3">
            ...
            @if (in_array($lesson->status, ['draft', 'returned']))
                <button type="button" wire:click="submit" class="bg-signal-teal text-white text-sm px-4 py-2 rounded hover:bg-signal-teal/90">
                    Submit for Review
                </button>
            @endif
        </div>
